  ...
  return (
    <div className='ml-20 max-sm:ml-0 max-sm:p-20  relative'>
        ...
        <div className='ml-72 max-sm:ml-0 w-[50%] max-sm:w-full'>
            <h1 className='text-5xl sm:text-8xl font-bold second-heading'>WEB</h1>
            <p className='text-[#6A6A6A] opacity-80 italic text-lg mt-8'>With the help of our apps, websites, and designs, discover countless growth prospects.</p></div>
        </div>
  )
}

export default HeadingSwitcher2
